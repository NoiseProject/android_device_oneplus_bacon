...
# Enhanced NFC
$(call inherit-product, vendor/np/config/nfc_enhanced.mk)

# Inherit some common NP stuff.
$(call inherit-product, vendor/np/config/common_full_phone.mk)

PRODUCT_NAME := np_bacon
